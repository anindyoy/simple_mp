<x-filament-widgets::widget>
    <div class="space-y-2">
        <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-200">Lapak Aktif</h4>
            ...
            <table class="fi-ta-table w-full text-start">
                <thead>
                    <tr class="border-b border-gray-200 dark:border-white/10">
                        ...
                        <th class="px-3 py-2 text-center text-xs font-semibold uppercase text-gray-500 dark:text-gray-400">Lapak Baru</th>
