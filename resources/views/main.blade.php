...
@section('content')
    ...
    @if (config('app.demo_mode'))
        <div x-data="{ show: !sessionStorage.getItem('demoBannerDismissed') }" x-show="show" x-cloak
            class="bg-yellow-50 border-b border-yellow-200 dark:bg-yellow-900/20 dark:border-yellow-800">
            <div class="container mx-auto px-4 py-3 flex items-center gap-3 text-sm text-yellow-800 dark:text-yellow-300">
                ...
                <button type="button" @click="show = false; sessionStorage.setItem('demoBannerDismissed', '1')"
                    class="shrink-0 rounded p-1 hover:bg-yellow-100 dark:hover:bg-yellow-900/40 transition"
